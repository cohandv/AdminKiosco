<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="AdminKiosco.Web.Account.OpenAuthProviders" %>

<fieldset class="open-auth-providers">
    <legend>Entrar usando otro servicio de autenticacion</legend>
    
    <asp:ListView runat="server" ID="providerDetails" ItemType="Microsoft.AspNet.Membership.OpenAuth.ProviderDetails"
        SelectMethod="GetProviderNames" ViewStateMode="Disabled">
        <ItemTemplate>
            <button type="submit" name="provider" value="<%#: Item.ProviderName %>"
                title="Entrar usando su <%#: Item.ProviderDisplayName %> account.">
