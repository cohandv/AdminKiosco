<%@ Page Title="Administrar cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="AdminKiosco.Web.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <p>Estas logueado como: <strong><%: User.Identity.Name %></strong>.</p>
                ...
                <ol>
                    <li>
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="password"
                            CssClass="field-validation-error" ErrorMessage="La password es requerida."
                    ...
                    <li>
                        <asp:Label runat="server" AssociatedControlID="confirmPassword">Confirmar password</asp:Label>
                        <asp:TextBox runat="server" ID="confirmPassword" TextMode="Password" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="confirmPassword"
                            CssClass="field-validation-error" Display="Dynamic" ErrorMessage="La password es requerida."
                            ValidationGroup="SetPassword" />
                        <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="confirmPassword"
                            CssClass="field-validation-error" Display="Dynamic" ErrorMessage="Las passwords no coinciden."
                            ValidationGroup="SetPassword" />
                    </li>
                </ol>
            ...
            <asp:ChangePassword runat="server" CancelDestinationPageUrl="~/" ViewStateMode="Disabled" RenderOuterTable="false" SuccessPageUrl="Manage?m=ChangePwdSuccess">
                <ChangePasswordTemplate>
                    ...
                    <fieldset class="changePassword">
                        <legend>Detalle cambio de password</legend>
                        <ol>
                            <li>
                                <asp:Label runat="server" ID="CurrentPasswordLabel" AssociatedControlID="CurrentPassword">Password actual</asp:Label>
                            ...
                            <li>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="field-validation-error" Display="Dynamic" ErrorMessage="La password de confirmación es requerida."
                                    ValidationGroup="ChangePassword" />
                                <asp:CompareValidator runat="server" ControlToCompare="NewPassword" ControlToValidate="ConfirmNewPassword"
                                    CssClass="field-validation-error" Display="Dynamic" ErrorMessage="Las paswords no coinciden."
                                    ValidationGroup="ChangePassword" />
                            </li>
                        </ol>
    ...
    <section id="externalLoginsForm">
        ...
        <asp:ListView runat="server"
            ...
            <LayoutTemplate>
                <h3>Autenticacion externa registrada</h3>
                <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Eliminar" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Eliminar " + Item.ProviderDisplayName + " login de su cuenta" %>'
